...
public class SysRoleController extends BaseController
{
    ...
    {
        return toResponse(roleService.deleteAuthUser(userRole));
    }
    ...
    {
        return toResponse(roleService.deleteAuthUsers(roleId, userIds));
    }
    ...
    {
        return toResponse(roleService.insertAuthUsers(roleId, userIds));
    }
}
